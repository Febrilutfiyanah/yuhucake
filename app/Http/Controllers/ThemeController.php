...
class ThemeController extends Controller
{
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('themes.index')->with('successMessage', 'Theme deleted successfully.');
    }
    ...
    {
        Theme::query()->update(['status' => 'inactive']);
        Theme::where('id', $id)->update(['status' => 'active']);

        return redirect()->route('themes.index')->with('successMessage', 'Tema berhasil diaktifkan.');
    }
}